...
from lakehouse.silver.service import SilverPersistedResult, load_persisted_silver_result
...
def build_and_persist_sales_gold(
    settings: Settings,
    silver_result_loader: Callable[..., SilverPersistedResult] = load_persisted_silver_result,
